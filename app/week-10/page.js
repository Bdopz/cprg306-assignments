        ...
        <main>
            ...
            :
                <div className="w-fit mx-auto flex flex-col mt-10">
                    ...
                    <Link href="week-10/shopping-list" className="w-fit mx-auto bg-blue-500 py-2 px-5 mt-20 rounded-sm hover:cursor-pointer hover:bg-blue-400">Shopping List</Link>
